...
const style = {
  wrapper: `flex justify-center h-screen w-sreen select-none bg-[#15202b] text-white`,
...
const Home = () => {
  ...
  const { appStatus, connectWallet } = useContext(BlogContext)
  ...
  const noUserFound = (
    <div className={style.loginContainer}>
      <div className={style.walletConnectButton} onClick={() => connectWallet()}>
        Connect Wallet
      </div>
